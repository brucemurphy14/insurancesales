...
public class Auto_PolicyController {
    ...
    @Autowired
    public Auto_PolicyController(ClientService clientService, Auto_PolicyJDbcdao autoPolicyJDbcdao) {
