...
insert into address (street_address, province, city, zip_code) VALUES ("37 peet street", "Newfoundland & Labrador", "St John's", "A1AB0");
insert into address (street_address, province, city, zip_code) VALUES ("11 yeet Buckmaster circle", "Triton", "Mt. Pearl", "A11BAS");

insert into client (main_insured_first_name, main_insured_last_name, home_policy_number, auto_policy_number, address_id, user_id, client_birthday)
values ("jimmy", "brown", 1, 1, 1, 1, '1980-1-1');

insert into client (main_insured_first_name, main_insured_last_name, home_policy_number, auto_policy_number, address_id, user_id, client_birthday)
values ("CARL", "WARNER", 2, 2, 2, 2, '1999-1-1');
...
INSERT into home (policy_number, age_since_built, type_of_dwelling, heating_type) values (10.0, 10.0, 'Detached', 'Oil');
insert into car (policy_number, vehicle_make, vehicle_model, vehicle_year) VALUES (0, "Honda", "Accord", 1999);

INSERT into home (policy_number, age_since_built, type_of_dwelling, heating_type) values (2, 60.0, 'Bungalow', 'Wood');

insert into car (policy_number, vehicle_make, vehicle_model, vehicle_year) VALUES (0, "Mazda", "ZoomZoom",2007);
